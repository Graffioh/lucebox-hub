...
| `--paged-attention` | off | Exact 16-token block-table decode for single-device Qwen3.5/3.6 dense or all-GPU MoE AR; see [paged attention](optimizations/paged_attention/README.md) |
