...
int main() {
    ...
    const ConcatCase cases[] = {
        {"decode_tail",       3,   1,    65, 3},
        {"tiny",              1,   2,    33, 2},
        {"token_tail",        3,  31,    63, 1},
        {"exact_tile",        7,  32,    64, 2},
        {"both_tails",        3,  33,    65, 3},
        {"wide_tail",         3, 511,   130, 1},
        {"max_prefix",       32, 513,   129, 1},
        {"qwen_prefill",      3, 512, 10240, 1},
        {"prefix_fallback",  33,  17,    35, 2},
    };
