...
static void t1_single_pass_match() {
    ...
    dflash::pflash::AnchorScanCfg cfg{CHUNK, /*anchor_radius=*/0,
                                     /*max_anchor_hits=*/8, /*ngram=*/4};
    dflash::pflash::scan_and_force(ids, q0, query_pool, cfg, forced);
...
static void t3_transitive_rescues_all() {
    ...
    dflash::pflash::AnchorScanCfg cfg{CHUNK, /*anchor_radius=*/0,
                                     /*max_anchor_hits=*/8, /*ngram=*/4};
    dflash::pflash::scan_and_force_transitive(ids, q0, initial_query_pool,
...
static void t5_gate_closes_when_pass1_finds_many() {
    ...
    // --- Test A: gate CLOSED (cascade_min_anchor_count=5) ---
    {
        ...
        dflash::pflash::scan_and_force_transitive(ids, q0, query_pool,
