...
sequentially through the luce server, and reports per-turn latency
under two configs: prefix-cache enabled vs disabled.

Usage:
    python3 server/scripts/bench_agent_loop.py [--turns N] [--session PATH]
...
replies are generated by the luce server (small max_tokens to keep
