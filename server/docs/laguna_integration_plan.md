...
- `pflash_daemon` (test/pflash_daemon.cpp): drafter-only stdin compressor, loads Qwen3.5-0.8B via dflash's own loader, emits compressed token IDs in DRAFTER vocab. Already model-agnostic on the target side. **No change needed.**
