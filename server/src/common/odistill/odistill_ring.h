// odistill_ring.h — engine side of the ODistill capture ring (ODISTILL.md §3-4).
//
...
class ODistillRing {
public:
    ODistillRing() = default;
    ~ODistillRing() { close(); }
    ODistillRing(const ODistillRing &) = delete;
    ODistillRing & operator=(const ODistillRing &) = delete;
    ...
    bool push(ODistillRecordHeader header,
    ...
    bool push2(ODistillRecordHeader header,
...
private:
    ...
    ODistillRingHeader * hdr_ = nullptr;
