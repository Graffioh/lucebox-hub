...
// written into per-slot scratch slabs. With capture_tree_commit, recurrent
// transitions and target features are exposed for post-verification promotion.
bool build_target_step_paged_tree(
    ...
    bool capture_tree_commit = false);
