...
public:
    ...
    // Copy a ready F32 hidden buffer directly from a second GPU into the
    // target projection graph. The caller owns source synchronization; no
    // host round-trip is performed here.
