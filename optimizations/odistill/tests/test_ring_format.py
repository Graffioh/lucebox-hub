"""Contract tests for the capture-ring mirror (odistill.ring_format).

The binding layout is server/src/common/odistill/odistill_format.h; the C++ side
pins the same bytes in server/test/test_odistill_unit.cpp. The golden STEP
...
from odistill.ring_format import (
    HEADER_SIZE,
    OFF_HEAD,
    REC_CONTEXT,
    REC_PAD,
...
# Copied verbatim from server/test/test_odistill_unit.cpp
