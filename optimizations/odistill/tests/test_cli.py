...
from odistill.cli import parse_args
from odistill.identity import (fnv1a64, require_sha256,
...
def test_direct_mode_hash_helper_is_exact(tmp_path):
    ...
    model.write_bytes(b"odistill identity\n")
    digest = sha256_file(str(model))
    assert digest == "55f809298d0b4c4fb704ea47a77fb696642f6ee77e3d357003fa2becddc22065"
