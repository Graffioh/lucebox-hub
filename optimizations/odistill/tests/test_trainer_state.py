"""CPU-only state-management regressions for the ODistill trainer."""
...
import odistill.trainer as trainer_module
from odistill.identity import fnv1a64
from odistill.ring_format import REC_CONTEXT, Record
from odistill.trainer import (
    SeqStore,
    StepSample,
    Trainer,
...
def _trainer(*, out_dir="/tmp/odistill-test-does-not-exist",
             device="cpu") -> Trainer:
    cfg = SimpleNamespace(
        start_generation=0,
        out_dir=out_dir,
