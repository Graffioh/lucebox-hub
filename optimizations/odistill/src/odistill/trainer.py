"""Online training loop for the ODistill trainer sidecar (ODISTILL.md §5).
...
class Trainer:
    ...
    def _sample_loss(self, store: SeqStore, sample: StepSample,
        ...
        Label alignment (odistill_format.h §STEP): target_tok[i] is the
