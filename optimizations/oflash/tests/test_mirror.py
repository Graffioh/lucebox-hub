"""Executable spec for oflash.mirror.DrafterMirror (torch drafter mirror).

Both `torch` and `oflash.mirror` are importorskip'd, so this file skips
...
mirror = pytest.importorskip("oflash.mirror",
                             reason="oflash.mirror not implemented yet")

from oflash.adapter_export import DrafterDims, expected_tensor_shapes  # noqa: E402
